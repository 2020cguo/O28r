...
function _picocli_pmd_check() {
  ...
  local arg_opts="--encoding -e --dir -d --file-list --uri -u --relativize-paths-with -z --format -f --report-file -r --use-version --force-language --aux-classpath --cache --threads -t --rulesets -R --ignore-list --suppress-marker --minimum-priority --property -P"

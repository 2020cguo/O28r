#!/bin/sh
# call pmd
SOURCE_DIR="hbase/"     # parent directory of all source code, relative to O28r
# SOURCE_FILE="zookeeper"
OUTPUT_DIR="hbase_output"       # parent directory of output files, relative to O28r
JAR_FILE_DIR="hbase_lib/"   # parent directory containing jar files, relative to java-callgraph
